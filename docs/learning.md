...
|----------|--------|----------|
| Tour of Go | https://go.dev/tour/ | Интерактивный туториал с нуля, прямо в браузере |
...
| Материал | Ссылка | Описание |
|----------|--------|----------|
| Get Started | https://docs.docker.com/get-started/ | Официальный туториал Docker |
| Docker Compose | https://docs.docker.com/compose/ | Документация Compose |
| Dockerfile reference | https://docs.docker.com/reference/dockerfile/ | Все инструкции Dockerfile |
| Best practices | https://docs.docker.com/build/building/best-practices/ | Как правильно писать Dockerfile |

## PostgreSQL

| Материал | Ссылка | Описание |
|----------|--------|----------|
| Документация | https://www.postgresql.org/docs/16/ | Официальная документация PostgreSQL 16 |

## Nginx

| Материал | Ссылка | Описание |
|----------|--------|----------|
| Beginner's Guide | https://nginx.org/en/docs/beginners_guide.html | Основы конфигурации |
| Документация | https://nginx.org/en/docs/ | Полная документация |

## GitHub Actions

| Материал | Ссылка | Описание |
|----------|--------|----------|
| Quickstart | https://docs.github.com/en/actions/writing-workflows/quickstart | Быстрый старт |
| Документация | https://docs.github.com/en/actions | Полная документация |
